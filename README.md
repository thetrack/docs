# TheTrack.io - Инновации UBER для всех отраслей
---
...
{% common -%}
<img src="../assets/arriving.gif"></img>
...
{% common -%}
<img src="../assets/nearest.gif"></img>
...
{% common -%}
<img src="../assets/accounting.gif"></img>
...
#### Короткая ссылка на карту с отслеживанием для любых браузеров.
* Позволит делиться через СМС, или другие текстовые сообщения, картой с отслеживанием процесса выполнения поставленной задачи в реальном времени.
* Позволит клиенту в реальном времени отслеживать статус его заказа.
